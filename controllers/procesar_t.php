<?php
    class bajas{ 
        public function store($id, $para, $de, $elaborado, $revisado, $aprovado, $usuariosTemp, $id_om, $id_sm, $parrafo){
            ...
            $link = '../vendor/export.php?&om_memo='.$id_om. '&parrafo='.$parrafo. '&sm_memo='.$id_sm.'&t_memo='.$id;
